...
namespace Students.Controllers
{
    public class KidsController : Controller
    {
        ...
        public KidsController(StudentsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Kids kids)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Kids kids)
        {
            if (id != kids.Id)
            {
                return NotFound();
